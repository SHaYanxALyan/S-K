...
def menu():
		...
		#	linex()
			...
			if xd in ['1','01']:
				...
				print(' Total OK/CP: '+str(len(CP))+'/'+str(len(cps)))
				linex()
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [SK-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(CP)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [SK-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(CP)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [SK-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(CP)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [SK-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(CP)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [SK-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(CP)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,CP,cps
	sys.stdout.write('\r\r\033[1;37m [SK-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(CP)));sys.stdout.flush()
...
def api7(ids,names,passlist):
	global loop,CP,cps
	sys.stdout.write('\r\r\033[1;37m [SK-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(CP)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,CP,cps
	sys.stdout.write('\r\r\033[1;37m [SK-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(CP)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def trt4(ids,passlist):
        global loop
        global CP
        sys.stdout.write('\r\r\033[1;37m [SK-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(CP)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
